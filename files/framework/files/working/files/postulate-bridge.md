...
**Type:** Program
**State:** Active
**Status (2026-07-01):** The staged route is resolved as a split (gauge dictionary proved, Möbius channel decoupled route-specifically). The sampler reading closed negative twice over; the variational reading is recorded open. The dynamical direction is the live front.
