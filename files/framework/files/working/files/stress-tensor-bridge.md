...
**Type:** Program
**State:** Active
**Status (2026-09-01):** Open program page, first cycle complete: nothing derived (no X→g_eff, no X→T_eff, no action). The variational route is promoted to preferred for the construction step.
...
**Inputs:** `../../../../cosmos/files/cosmological-constant.md` §IV, `budget-map.md`, `friedmann-as-output.md`, `temporal-budget.md`, `../../bedrock/files/first-eigenvalue.md`
