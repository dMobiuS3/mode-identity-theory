...
A Euclid DR1 stacked analysis at $z = 2$ stratified by both galaxy stellar mass and aperture therefore tests the framework on two independent axes simultaneously. First, the magnitude of the redshift shift (74% predicted vs $\sim 0\%$ under ΛCDM at $L^*$). Second, its universality across mass and aperture (universal under MIT vs varying by 36 percentage points across the dwarf-to-giant range under ΛCDM).
