...
| Rank 16 target | 418 MeV entry ($`R_5`$, gal) with no measured match. A colored state at that mass with ordinary couplings is excluded, so the structural-residual reading is the default here; the physical reading needs an explicit coupling-suppression argument this page does not have. |
