...
| [↗](files/mass-spectrum.md#1-neutrino-floor--mu_lambda) $`\mu_\Lambda`$ mass-sector floor | $`\mu_\Lambda \approx 2.25`$ meV | absolute neutrino masses unmeasured; KATRIN $`m_{\nu_e}^\text{eff} < 0.45`$ eV (90% CL) | awaiting measurement |
