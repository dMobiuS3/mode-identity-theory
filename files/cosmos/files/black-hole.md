...
Potential observational signatures (all require detailed modeling, and depend on which of the above the shells are). Photon-mediated signatures should use the bosonic subgrid, $k=2,4,\ldots,32$, 16 finite addresses, not the full 33-shell grid:
