...
The $`\Theta \to 0`$ zero of $`C`$ has an exact structural analog in the spectral geometry of $`S^3/2I`$; $`\Omega_H`$'s conjectured, separate zero (§II) has no established analog here.
...
| $`\Omega_H \to 0`$ conjectured to collapse hierarchy (OPEN, §II) | $`(s)_k = 0`$ for $`k \geq 1`$ collapses the Pochhammer tower to its $`k=0`$ survivor; that survivor must separately vanish for $`Z_\sigma(0)=0`$ |
| Parallel in structure, not a proven joint limit: $`\Theta \to 0`$ is derived, $`\Omega_H \to 0`$ is conjectured | Tower collapse plus a vanishing survivor, one structure not two |
...
/ **[`↑top`](#top)** / **[`main`](/README.md)** / **[`framework`](/files/framework/)** / **[`bedrock`](/files/framework/files/bedrock/)** / **[`working`](/files/framework/files/working/)** / **[`cosmos`](/files/cosmos/)** / **[`spectrum`](/files/spectrum/)** / **[`tools`](/files/tools/)** /
