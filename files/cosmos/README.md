/ **[`main/`](../../READ.ME)** / **[`framework/`](../framework/)** / **[`cosmos/`](../cosmos/)** / **[`spectrum/`](../spectrum/)** /
...
| [↗](files/cmb-anomalies.md) CMB $\ell_\text{cut}$ | ~32 | deficit below $\ell \lesssim 30$ | ✓ |
| [↗](files/cmb-anomalies.md) CMB parity sign | $R_{TT} < 1$ | $R_{TT} \approx 0.81$ | ✓ |
| [↗](files/cmb-anomalies.md) CMB parity magnitude | $R_{TT} = 0.814$ | $R_{TT} \approx 0.81$ | 0.5% |
| [↗](files/cmb-anomalies.md) CMB alignment | exists | $\Delta\theta_{23} \approx 10°$ | ~ |
...
| [↗](files/hubble-tension.md) $H_0$ bimodality | 67 / 73, not continuous | two persistent camps | ✓ |
