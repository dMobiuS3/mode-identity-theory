...
Three predictions separate this framework from alternatives: a₀(z) tracks with H(z) while $\Lambda$ remains constant, and phantom crossing at $z \approx 0.66$ is an inference artifact, not evolving vacuum energy.
